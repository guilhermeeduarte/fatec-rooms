  ...
  if (loading) {
    return (
        <LoadingState
            ...
            heroTag="Análise de Reservas"
            heroTitle="Relatórios de Uso"
            heroDescription="Visualize estatísticas de utilização das salas — simples e recorrentes."
      ...
      <>
        ...
        <div className="layout-relatorios">
          ...
          {activeTab === "salas" && (
              <>
                {/* Stats */}
                <div className="stats-row" style={{ marginLeft:"-20px",marginRight:"-20px", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))" }}>
